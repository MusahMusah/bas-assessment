...
<body>
    ...
    <form method="GET" action="<?php echo e(route('salary.payment-date')); ?>">
        <div class="content">
            <label>
                <select name="year">
...
<?php /**PATH /Users/macbookpro/Desktop/Apps/php-apps/assessment/resources/views/welcome.blade.php ENDPATH**/ ?>